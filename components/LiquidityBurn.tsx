  ...
  return (
    <section id="liquidity" className="px-4 py-20 sm:px-6">
      <div className="mx-auto max-w-5xl">
        <Reveal>
          <p className="text-center text-xs font-extrabold uppercase tracking-[0.3em] text-forest-600">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-center text-base text-foreground/80 sm:text-lg">
        ...
        <Reveal delayMs={280}>
          <div className="mt-8 flex flex-col items-center gap-4 rounded-2xl border-2 border-dashed border-gold-500/50 bg-forest-900/40 p-8 text-center">
            <div className="flex items-center gap-3 text-2xl font-extrabold uppercase tracking-wide text-gold-300 sm:text-3xl">
