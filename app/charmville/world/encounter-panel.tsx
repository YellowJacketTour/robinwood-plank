...
export type Snapshot={participants?:Participant[];events?:CombatEvent[];profileId:string;actorEpoch:number;inRange:boolean;legalActions:Action[];encounter:{id:string;speciesId:number;name:string;level:number;hp:number;maxHp:number;statuses:string[];mode:'world'|'turn';controllerId:string|null;revision:string}};
