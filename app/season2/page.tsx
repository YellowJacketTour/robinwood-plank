...
export const metadata = createPageMetadata({
  title: "Season 2 · King of the Hill",
  description:
    "The largest single $PLANK buy over 31 days wins 0.69420% of total supply. Live leaderboard, live prices, real anti-fraud verification on every buy.",
  path: "/season2",
  keywords: ["PLANK King of the Hill", "Season 2", "largest PLANK buy", "PLANK competition"],
});
