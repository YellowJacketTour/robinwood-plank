...
http.createServer(async(req,res)=>{
 try{
  ...
  if(url.pathname.startsWith('/action-sprites/')){
   ...
   if(!['manifest.json','hoe-fg.png','hoe-bg.png','water-fg.png','water-bg.png','gold-hair.png','berry-dirt.png','berry-sprout.png','berry-oran.png','follower-treecko.png','follower-torchic.png','follower-mudkip.png','follower-pikachu.png','follower-eevee.png','follower-poochyena.png'].includes(name)){res.writeHead(404,headers);res.end();return;}
