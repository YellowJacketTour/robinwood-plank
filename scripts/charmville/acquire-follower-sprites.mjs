...
const files=['LICENSE.md','README.md',...['0252','0255','0258'].flatMap(id=>['Walk-Anim.png','Walk-Offsets.png','Walk-Shadow.png','AnimData.xml','credits.txt'].map(name=>`sprite/${id}/${name}`))];
const manifest=[];
