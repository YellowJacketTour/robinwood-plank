...
export function nativeResourceRequestPolicy(request:Request,env:Record<string,string|undefined>=process.env,acceptedRelease=false):NativeResourcePolicy|undefined {
 ...
 if(!((env.NODE_ENV==='production'&&acceptedRelease===true)||(env.NODE_ENV==='development'&&env.CHARMVILLE_NATIVE_CROP_PROTOCOL==='2')))return;
