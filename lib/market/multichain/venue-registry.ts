...
export const MARKET_VENUES = [
  ...
  { id: "ordnet-bitcoin", label: "ORD.NET", family: "bitcoin", protocol: "ordinals-market", versions: ["v1"], capabilities: ["sales", "listings", "bids"], coverage: "planned", chainSlugs: ["bitcoin-mainnet"], notes: "Official OpenAPI supports collection membership, order books, and negotiated offers. Authentication requires a wallet challenge and a payment address holding 0.01 BTC, so it is not an anonymous server feed." },
  { id: "gamma-bitcoin", label: "Gamma Ordinals", family: "bitcoin", protocol: "ordinals-market", versions: ["historical", "current"], capabilities: ["sales", "listings"], coverage: "planned", chainSlugs: ["bitcoin-mainnet"], notes: "Distinct venue catalog/history lane. No verified public server API contract is currently wired; never scrape UI HTML into canonical evidence." },
